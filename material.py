...
r[0] = material("Avicel PH102 + 1% MgSt",3.7*10**-4,-10.49,-0.0312,2.088)
r[1] = material("Lactose 316 + 1% MgSt",5.1*10**-2,-15.57,-0.0312,2.083)
r[2] = material("VX-445 EG",5.6*10**-4,-10.16,-0.0999,2.144)
r[3] = material("VX-121 EG",1.7*10**-4,-10.04,-0.12,1.739)